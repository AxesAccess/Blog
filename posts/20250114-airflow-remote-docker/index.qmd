...
Note, that if you will run `sudo` as the `airflow` user, you will need to
add the user to the `sudoers` file. You can do this by adding the
...
free to leave a comment under the LinkedIn post.
