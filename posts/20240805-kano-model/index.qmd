...
![](minh-gCL_rWClhpU-unsplash.jpg)

::: {style="font-size: small;"}
Photo by
[Minh](https://unsplash.com/@minhh11hh?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash)
on
[Unsplash](https://unsplash.com/photos/a-long-exposure-of-a-star-trail-in-the-night-sky-gCL_rWClhpU?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash)
:::
...
For illustrative purposes, let's consider existing dataset with responses to a
Kano questionnaire from [Doing Research Online: The Kano
...
questions for each feature. The table below shows an example of aggregated
answers for a feature with ID = F1.
